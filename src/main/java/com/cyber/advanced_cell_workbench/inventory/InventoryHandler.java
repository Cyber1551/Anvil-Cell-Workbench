package com.cyber.advanced_cell_workbench.inventory;
...
//import com.cyber.advanced_cell_workbench.network.CPacketSwitchGuis;
...
//        AdvancedCellWorkbenchMod.proxy.netHandler.sendToServer(new CPacketSwitchGuis(guiType));
//    }

    public static void openGui(EntityPlayer player, World world, BlockPos pos, EnumFacing face, GuiType guiType) {
        try {
            player.openGui(AdvancedCellWorkbenchMod.INSTANCE,
