...
import com.cyber.advanced_cell_workbench.interfaces.IHasCustomModel;
...
public class ClientRegistryHandler extends RegistryHandler {
    ...
    private static void registerModel(String key, Item item) {
        ModelLoader.setCustomModelResourceLocation(item, 0, new ModelResourceLocation(
                item instanceof IHasCustomModel ? ((IHasCustomModel)item).getCustomModelPath() : AdvancedCellWorkbenchMod.resource(key),
                "inventory"));
    }
