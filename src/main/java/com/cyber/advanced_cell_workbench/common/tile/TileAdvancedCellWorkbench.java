package com.cyber.advanced_cell_workbench.common.tile;
...
public class TileAdvancedCellWorkbench extends AEBaseTile implements IUpgradeableHost, IAEAppEngInventory, IConfigManagerHost {
    ...
    public TileAdvancedCellWorkbench() {
    ...
    private void handleCellInventoryChange(final ItemStack newStack, final ItemStack removedStack) {
        ...
        if (configInventory != null) {
            ...
            clearOrResetConfiguration(newStack, removedStack);
        }
    ...
    private void clearOrResetConfiguration(final ItemStack newStack, final ItemStack removedStack) {
...
//    @Override
//    public void onChangeInventory(final IItemHandler inv, final int slot, final InvOperation invOperation, final ItemStack removedStack, final ItemStack newStack) {
...
//                if (!newStack.isItemEqual(removedStack) && !newStack.isEmpty()) {
//                    if (this.manager.getSetting(Settings.COPY_MODE) == CopyMode.CLEAR_ON_REMOVE) {
//                        this.setCustomNameText(newStack.getDisplayName());
//                    }
//                }
