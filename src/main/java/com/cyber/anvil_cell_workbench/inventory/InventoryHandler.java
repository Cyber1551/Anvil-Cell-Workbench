package com.cyber.anvil_cell_workbench.inventory;
...
public class InventoryHandler implements IGuiHandler {
    ...
    public static void openGui(EntityPlayer player, World world, BlockPos pos, EnumFacing face, GuiType guiType) {
        try {
            player.openGui(AnvilCellWorkbenchMod.INSTANCE, (guiType.ordinal() << 3) | face.ordinal(), world, pos.getX(), pos.getY(), pos.getZ());
