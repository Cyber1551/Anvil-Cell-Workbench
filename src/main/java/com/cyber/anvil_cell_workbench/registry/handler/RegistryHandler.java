package com.cyber.anvil_cell_workbench.registry.handler;
...
import com.cyber.anvil_cell_workbench.loader.ModItems;
...
public class RegistryHandler {
    ...
    public void onRegisterBlocks(RegistryEvent.Register<Block> event) {
        for (Pair<String, Block> entry : blocks) {
            ...
            block.setTranslationKey(AnvilCellWorkbenchMod.MODID + ":anvil_cell_workbench");
            block.setCreativeTab(ModItems.TAB_ANVIL_CELL_WORKBENCH);
    ...
    private static Item initItem(String key, Item item) {
        ...
        item.setTranslationKey(AnvilCellWorkbenchMod.MODID + ":" + key);
        item.setCreativeTab(ModItems.TAB_ANVIL_CELL_WORKBENCH);
        return item;
    }
    ...
    public void onInit() {
        for (Pair<String, Block> entry : blocks) {
            ...
            Block block = ForgeRegistries.BLOCKS.getValue(AnvilCellWorkbenchMod.resource(entry.getKey()));
