package com.cyber.anvil_cell_workbench.common.container;
...
public class ContainerAnvilCellWorkbench extends ContainerUpgradeable {

    private final TileAnvilCellWorkbench workbench;
    ...
    public ContainerAnvilCellWorkbench(final InventoryPlayer ip, final TileAnvilCellWorkbench te) {
        super(ip, te);
        this.workbench = te;
    }
    ...
    public void onSlotChange(Slot slot) {
        ...
        if (this.getWorkbenchCopyMode() == CopyMode.KEEP_ON_REMOVE) {
            ...
            AnvilCellWorkbenchMod.proxy.netHandler.sendToServer(new CPacketValueConfig(PacketType.CellName, this.getCustomNameText()));
        }
    }
